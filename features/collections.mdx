...
<Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Collections+overview+page" alt="Collections overview page showing multiple colorful collection cards, each displaying collection nam" />
</Frame>
...
<Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Create+Collection+modal" alt="Create Collection modal showing input fields for name, description, and a color picker with preset" />
</Frame>
...
<Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Paper+detail+page" alt="Paper detail page showing the "Add to Collection" button and a dropdown menu listing available colle" />
</Frame>
...
<Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Collection+detail+view" alt="Collection detail view showing a list of papers with the collection name and description at the top," />
</Frame>
...
<Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Chat+interface+showing" alt="Chat interface showing the menu dropdown with "Add to Collection" option highlighted" />
</Frame>
...
<Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Multiple+collection+cards" alt="Multiple collection cards showing different colors (red, blue, green, yellow, purple, orange) arrang" />
</Frame>
