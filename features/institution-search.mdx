...
<Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Institution+search+page" alt="Institution search page showing a search bar at top and grid of institution cards below, each with l" />
</Frame>
...
<Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Institution+search+results" alt="Institution search results showing 5-6 institution cards with names, logos, locations, and key stats" />
</Frame>
...
<Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Filter+panel+showing" alt="Filter panel showing dropdown menus for Country, Type, Research Areas, and sliders for Size and Publ" />
</Frame>
...
<Tabs>
  <Tab title="Overview">
    ...
    **Key metrics:**
    ...
    <Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Institution+profile+header" alt="Institution profile header showing logo, name "MIT", location, and key metrics displayed as cards (p" />
</Frame>
  </Tab>
  ...
  <Tab title="Publications">
    ...
    **Features:**
    ...
    <Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Publications+tab+showing" alt="Publications tab showing list of papers with titles, authors, years, and citation counts, with filte" />
</Frame>
  </Tab>
  ...
  <Tab title="Researchers">
    ...
    **Actions:**
    ...
    <Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Researchers+tab+listing" alt="Researchers tab listing faculty members with profile pictures, names, departments, and key metrics" />
</Frame>
  </Tab>
  ...
  <Tab title="Collaborations">
    ...
    **Visualizations:**
    ...
    <Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Collaborations+tab+showing" alt="Collaborations tab showing a network graph of connected institutions with MIT at the center" />
</Frame>
  </Tab>
  ...
  <Tab title="Statistics">
    ...
    **Additional stats:**
    ...
    <Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Statistics+tab+showing" alt="Statistics tab showing line charts for publications and citations over time, plus breakdown by resea" />
</Frame>
  </Tab>
</Tabs>
...
<Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Institution+comparison+view" alt="Institution comparison view showing two institutions side-by-side with metrics for easy comparison" />
</Frame>
...
<Frame>
  <img src="https://placehold.co/1000x600/4F46E5/white?text=Paper+detail+showing" alt="Paper detail showing author list with institution names as clickable links" />
</Frame>
