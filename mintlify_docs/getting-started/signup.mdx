...
++IMAGE: **Signup form showing input fields for name, email, and password with password requirements listed below and a prominent "Sign Up" button**++
...
++IMAGE: **Verification email showing the Freiya logo, welcome message, and large 5-digit code displayed prominently with spacing between digits**++
...
++IMAGE: **Verification page showing input field for 5-digit code, "Verify Email" button, and "Resend Code" link below**++
...
++IMAGE: **Signup page with "Continue with Google" button prominently displayed, using Google's brand colors and logo**++
...
++IMAGE: **Sign in page showing email and password input fields, "Sign In" button, "Forgot Password?" link, and "Continue with Google" option below**++
...
++IMAGE: **Forgot Password page with email input field and "Send Reset Link" button**++
