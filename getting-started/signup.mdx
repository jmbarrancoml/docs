...
<Steps>
  <Step title="Visit signup page">
    Navigate to [freiya.app/auth/signup](https://freiya.app/auth/signup)
  </Step>
...
<Frame>
  <img src="https://placehold.co/600x550/4F46E5/white?text=Signup+Form" alt="Signup form with name, email, and password fields" />
</Frame>
...
<Steps>
  <Step title="Visit signup page">
    Go to [freiya.app/auth/signup](https://freiya.app/auth/signup)
  </Step>
...
<Steps>
  <Step title="Visit signin page">
    Go to [freiya.app/auth/signin](https://freiya.app/auth/signin)
  </Step>
...
<Frame>
  <img src="https://placehold.co/600x450/4F46E5/white?text=Sign+In+Page" alt="Sign in page with email and password fields" />
</Frame>
...
<Frame>
  <img src="https://placehold.co/600x350/4F46E5/white?text=Forgot+Password" alt="Forgot Password page with email input field" />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Can't sign in with Google">
    Possible issues:
    1. Pop-ups blocked by browser (allow for freiya.app)
...
Read our [Privacy Policy](https://freiya.app/privacy) for complete details.

## Need help?

Having trouble signing up or signing in?

- 📧 Email: support@freiya.app
